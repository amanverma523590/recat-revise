  ...
  return (
    <div className="container-fluid">
      ...
      <section className="mt-3 row">
        ...
        <main className="col-9 overflow-auto" style={{height:"500px",display:'flex',flexWrap:'wrap'}}>
          {
            products.map((product)=>(
              <div className="card p-2" key={product.id} style={{width:'200px'}}>

                { product.image ? ( <img src={product.image} alt="no img" height='120' className="card-img-top" /> ) : ( <div>no img</div> ) }
                <div className="card-header" style={{height:'120px',overflow:'hidden'}}>
                  <p>{product.title}</p>
                </div>
                ...
                <div className="card-footer">
                  <button name={product.id} onClick={handleAddClick} className="btn btn-dark w-100 bi bi-cart">
                    Add To Cart</button>
                </div>
